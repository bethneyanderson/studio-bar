...
class About(models.Model):
    ...
    # Programming Section
    programming_title = models.CharField(max_length=200, default="Programming & Production")
    programming_content = models.TextField(help_text="Content for the programming section")
    
    # Community Section
    community_title = models.CharField(max_length=200, default="Community & Partnerships")
